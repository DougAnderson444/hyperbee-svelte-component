...
export default {
  input: 'src/index.js',
  output: [
    { file: pkg.module, format: 'es', globals: { hyperbee: 'hyperbee' } },
    { file: pkg.main, format: 'umd', name, globals: { hyperbee: 'hyperbee' } }
  ],
  ...
  plugins: [
    ...
    commonjs({
      extensions: ['.mjs', '.js'],
      include: [/node_modules/, /hyperbee/], // require is not defined?
